...
namespace KYSProjectApi.Models
{
    public record LoginVm
    {
        ...
        [RegularExpression("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[!@#$%^&*]).{3,8}$", ErrorMessage = "Şifre en az bir büyük harf, bir küçük harf, bir rakam ve bir özel karakter içermeli ve 3-8 karakter uzunluğunda olmalıdır.")]
